...
{
    [Serializable]
    public struct BuffOnEmotionTowardCharacter : IIdentifiableBuff<(string, Emotion, EmotionModifier, Operation, int)>, IStackableBuff<BuffOnEmotionTowardCharacter>, IFloatValuableBuff, IEndableOnDateBuff, IPrintableBuff, 
        IValidableBuff, IContextValidableBuff
    {
        ...
        {
            return "Feelings Towards " + RichPrint(characterNameGetter, value, language);
        }

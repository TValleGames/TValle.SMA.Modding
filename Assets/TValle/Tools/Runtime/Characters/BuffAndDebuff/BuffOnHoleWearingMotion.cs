...
namespace Assets.TValle.Tools.Runtime.Characters.BuffAndDebuff
{
    ...
    public struct BuffOnHoleWearingMotion : IIdentifiableBuff<(SensitiveFemaleHole, SimpleModifier, AddOperation, int)>, IStackableBuff<BuffOnHoleWearingMotion>,
        IEquatable<BuffOnHoleWearingMotion>, IFloatValuableBuff, IEndableOnDateBuff, IPrintableBuff, IValidableBuff, IContextValidableBuff
    {
        ...
        {
            return "Loose-Stroked " + RichPrint(characterNameGetter, value, language);
        }
